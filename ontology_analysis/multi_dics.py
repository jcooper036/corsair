...
outfile = '/Users/Jacob/corsair/ontology_analysis/kegg_counting/' + hit_list.split('/')[-1].split('_')[0] + '_kegg_counting.csv'
...
with open(outfile, 'w') as f:    
    f.write("Pathway,Ratio,Hits,Total\n")
    for key in ratio_B:
        f.write("{},{},{},{}".format(key, ratio_B[key], len(count_B[key]), len(B[key])) + '\n')
    for key in ratio_C:
        f.write("{},{},{},{}".format(key, ratio_C[key], len(count_C[key]), len(C[key])) + '\n')
