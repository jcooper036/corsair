...
# tcoffeelib_struct
#
# bpm : 2d base pair array, bpm[i][j] i<j,
#       <=0 if unpaired, weight otherwise
#
...
# ---   plfold
#
# id needs to be clean from special characters
#
sub plfold($$$)
{    
